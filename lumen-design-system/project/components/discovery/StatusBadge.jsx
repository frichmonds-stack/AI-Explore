...
export const STATUS = {
  approved:   { label: 'CEWA Approved',   tip: 'Reviewed and approved for use in CEWA schools.' },
  pilot:      { label: 'Pilot',           tip: 'Approved for classroom pilots with teacher guidance.' },
  review:     { label: 'Under Review',    tip: 'Currently being evaluated by the CEWA AI team.' },
  restricted: { label: 'Not Approved',    tip: 'Not approved for student-facing use at this time.' },
  unreviewed: { label: 'Not Yet Reviewed',tip: 'No CEWA assessment yet — apply professional judgement.' },
};
